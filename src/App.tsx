        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                image: "https://images.unsplash.com/photo-1567016376408-0226e4d0c1ea?auto=format&fit=crop&q=80",
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
            ...
            <div className="bg-gray-800 rounded-2xl p-8 shadow-xl backdrop-blur-sm">
              ...
              <div className="mt-8 pt-8 border-t border-gray-700">
                ...
                <div className="space-y-4">
                  <a href="tel:+15551234567" className="flex items-center text-gray-400 hover:text-blue-400 transition-colors">
                    <Phone className="h-5 w-5 mr-3" /> +1 (555) 123-4567
                  </a>
                  ...
                  <p className="flex items-center text-gray-400">
                    <MapPin className="h-5 w-5 mr-3" /> 123 Comfort Lane, Design District
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400">© 2024 OnlyComfort. All rights reserved.</p>
